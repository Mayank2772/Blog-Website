    ...
    <div className='flex-1 pt-5 px-5 sm:pt-12 sm:pl-16 bg-blue-50/50'>
      <div className='flex justify-between items-center max-w-3xl'>
        ...
        <div className='flex gap-4'>
          ...
          <button onClick={()=>setfilter('Not Approved')} className={`shadow-custom-sm border rounded-full px-4 py-1 cursor-pointer text-xs ${filter === 'Not Approved'?'text-white bg-primary':'text-gray-700'}` }>Not Approved</button>
        </div>
      </div>
